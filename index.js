...
function TransomGraceful() {
	...
	this.initialize = function (server, options) {
		return new Promise(function (resolve, reject) {
			...
			const gracefulDefn = server.registry.get('transom-config.definition.graceful', {});
			...
			const serviceUnavailable = options.serviceUnavailableWhileStopping === false ? false : true;
